...
if (isset($_SESSION["uid"])) {
    ...
    '$address', '$city', '$state', '$zip','$cardname','$cardnumberstr','$expdate','$total_count','$prod_total','$cvv','$Status')";
   ...
   $mail ->Port = 465;   /*587;*/
   $mail ->IsHTML(true);
   $mail ->Username = "manoo.abhillash@gmail.com";
   $mail ->Password = "0754876995";
   $mail ->SetFrom("manoo.abhillash@gmail.com");
   $mail ->Subject = "Regarding order";
   $mail ->Body = "Your order has been placed succesfully";
   $mail ->AddAddress("COHDSE192F-040@student.nibm.lk");
