  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="img/printing.jpg" alt="Printing" style="width:100%;">
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=79"><div class="shop">
							<div class="shop-img">
								<img src="./img/cartridges.jpg" alt="">
							</div>
							<div class="shop-body">
								<h3>Cartridge<br>Collection</h3>
...
$nameOne=$_POST['ItemSearching'];



$query = "SELECT * FROM products where product_title like'%$nameOne%' ";
                        ...
                        echo "
								...
								<div class='product'>
									...
									<div class='product-body'>
										...
										<h3 class='product-name header-cart-item-name'><a href='product.php?p=$pro_id'>$pro_title</a></h3>
										<h4 class='product-price header-cart-item-info'>$pro_price<del class='product-old-price'>Rs 26,900.00</del></h4>
										<div class='product-rating'>
											<i class='fa fa-star'></i>
											<i class='fa fa-star'></i>
											<i class='fa fa-star'></i>
...
$nameOne="";
$query = "SELECT * FROM products where product_title='$nameOne' ";
				...
				<div class="row">
					<div class="col-md-12">
						<div class="hot-deal">
							...
							<h2 class="text-uppercase">Avurudu Sale</h2>
							...
							<div id="get_product_home2">
								...
								<div class="product-widget">
									...
									<div class="product-body">
										...
										<p class='product-category'>$cat_name</p>
										<h3 class="product-name"><a href="#">Special Offer</a></h3>
