      ...
      <div class="sidebar-wrapper ps-container ps-theme-default" data-ps-id="3a8db1f4-24d8-4dbf-85c9-4f5215c1b29a">
        <ul class="nav">
          ...
          <li class="div-2 ">
           ...
           <li class="div-2 ">
            <a class="nav-link" href="PowerBi.php" target="_blank">
              <i class="material-icons">edit_use</i>
              <p>Power Bi</p>
            </a>
          </li>
          <li class="div-2">
            <a class="nav-link" href="chart.php" target="_blank">
              <i class="material-icons">library_books</i>
